...
#ifndef VAD_PITCH_PROCESS
#define VAD_PITCH_PROCESS
#endif
#ifndef VAD_PROCESS_RECORD
//#define VAD_PROCESS_RECORD
#endif
...
enum { kAecNlpConservative = 0, kAecNlpModerate, kAecNlpAggressive, kAecNlpMusicmode};
...
typedef struct Aec {
  ...
  int farend_started;
#ifdef VAD_PITCH_PROCESS
  float smooth_voice_probability;
  float smooth_coeff;
  VoiceActivityDetector Pitchvad;
#endif
#ifdef VAD_PROCESS_RECORD
  FILE *pre_process_in;
  FILE *post_process_out;
#endif
